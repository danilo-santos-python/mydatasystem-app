# 🎓 MyDataSystem App — Sistema de Gerenciamento de Estudantes (PyQt6 + SQLite)
...
O **MyDataSystem App** foi criado com o propósito de simplificar a gestão de informações estudantis.  
...
git clone https://github.com/danilo-santos-python/mydatasystem-app.git
...
🌐 [Repositório do Projeto](https://github.com/danilo-santos-python/mydatasystem-app.git)
